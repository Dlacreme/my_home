" Name:         Cold Horizon
" Description:  Cold version of horizon color theme - based on Vincent Fiestada Visual Code Plugin
" Author:       Mathieu Delacroix <dlacreme@gmail.com>
" Maintainer:   Mathieu Delacroix <dlacreme@gmail.com>
" License:      Vim License (see `:help license`)

if !(has('termguicolors') && &termguicolors) && !has('gui_running')
      \ && (!exists('&t_Co') || &t_Co < 256)
  echoerr '[ColdHorizon] There are not enough colors.'
  finish
endif
...
hi! Statement ctermfg=171 gui=NONE guifg=#30AAD7
hi! Include ctermfg=171 guifg=#30AAD7
...
if has('nvim')
  ...
  let g:terminal_color_1 = '#E06783'
  let g:terminal_color_2 = '#0AF29D'
  ...
  let g:terminal_color_13 = '#30AAD7'
  let g:terminal_color_14 = '#95c4ce'
  let g:terminal_color_15 = '#d2d4de'
else
  let g:terminal_ansi_colors = ['#1c1e26', '#E06783', '#0AF29D', '#fab795', '#25b0bc', '#f09483', '#e95678', '#1c1e26', '#d5d8da', '#ec6a88', '#6bdfe6', '#fab38e', '#21bfc2', '#30AAD7', '#95c4ce', '#d2d4de']
endif
